      ...
      child: Stack(
        children: [
          FutureBuilder<QuerySnapshot>( //specify as not might be loaded data
            future: _firebaseServices.userReference.doc(_firebaseServices.getUserId()).collection("Saved").get(), //get all data
          ...
          CustomActionBar(
            hasBackArrow: false,
            title: "Saved Products", //basically same thing as Cart, saving data in firebase and displaying it
          ),
        ],
      ),
    );
